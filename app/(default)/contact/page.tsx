    ...
    <section>
      <div className="pt-32 pb-12 md:pt-44 md:pb-20">
        <div className="px-4 sm:px-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <select
                          id="company"
                          className="w-full pl-10 text-sm form-select"
                          defaultValue={0}
                          required
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        id="message"
                        className="w-full text-sm resize-none form-textarea"
          ...
          {/* Cards */}
          <div className="max-w-xs mx-auto md:max-w-6xl">
            <div className="grid gap-6 md:grid-cols-3 xl:gap-9 xl:mx-8 max-md:-mx-3">
              {/* Card */}
              <div className="flex flex-col p-5 rounded-lg bg-gradient-to-tr from-white/70 to-white/50 dark:bg-gradient-to-b dark:from-gray-700/50 dark:to-gray-700/40">
                <div className="mb-3 grow">
                  <div className="mb-1 font-semibold text-gray-800 font-inter-tight dark:text-gray-200">
                    Email
                  </div>
