export default function BgShapes() {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="absolute w-[960px] h-24 top-12 animate-[swing_8s_ease-in-out_infinite] before:absolute before:inset-0 before:rounded-tl-full before:rounded-br-full before:bg-gradient-to-b before:from-transparent before:to-transparent before:via-[var(--purple)] before:-rotate-[42deg]" />
      <div className="absolute w-[960px] h-24 -top-12 -left-28 animate-[swing_15s_-1s_ease-in-out_infinite] before:absolute before:inset-0 before:rounded-tl-full before:rounded-br-full before:bg-gradient-to-b before:from-transparent before:to-transparent before:via-white dark:before:via-[var(--purple)] before:-rotate-[42deg]" />
      ...
      <div className="absolute w-[960px] h-64 top-[820px] left-44 animate-[swing_10s_ease-in-out_infinite] before:absolute before:inset-0 before:rounded-tl-full before:rounded-br-full before:bg-gradient-to-b before:from-transparent before:to-transparent before:via-[var(--purple)]/30 dark:before:via-[var(--purple)]/30 before:-rotate-[42deg]" />
